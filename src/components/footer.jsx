        ...
        <div className="footer__info">
          <div className="footer__contact">
            ...
            <ul className="contact__list footer__list">
              <a href=""><li className="footer__el"><p className="el__text">Поддержка покупателей</p></li></a>
              <a href=""><li className="footer__el"><p className="el__text">Сотрудничество</p></li></a>
            </ul>
          </div>
